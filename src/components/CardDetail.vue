<template>
  <div style="height:300px" class="w-8/12 mx-auto grid grid-cols-2 gap-5 my-10">
    <div style="max-height:300px" class="overflow-hidden">
      <img class="rounded-lg" src="../assets/img/2.jpg" alt />
    </div>

    <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2 py-5">
