...
<div>
  <!-- component -->
  <body class="antialiased font-sans bg-gray-300">
    <div class="container mx-auto px-4 sm:px-8">
      <div class="py-8">
        <div>
          <h2 class="text-2xl text-gray-900 font-semibold leading-tight">Users</h2>
        </div>
            ...
            <table class="min-w-full leading-normal">
              ...
              <tbody>
                <tr>
                  <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <div class="flex items-center">
                      ...
                      <div class="ml-3">
                        <p class="text-gray-900 whitespace-no-wrap">cake Carpenter</p>
                      </div>
                    </div>
                  </td>
                  <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                ...
                <tr>
                  ...
                  <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    <p class="text-gray-900 whitespace-no-wrap">$ 60.00</p>
                  </td>
                  <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
